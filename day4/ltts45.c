...
Write a program to demonstrate the swapping 
the fields of two structures using pointers
...
int main() {
  struct student s1 = {"Nandhu", 51, 90.0};
  struct student s2 = {"Indira", 21, 80.0};
